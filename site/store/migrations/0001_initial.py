    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_price', models.DecimalField(decimal_places=2, max_digits=65, verbose_name='Regular price')),
                ('discount_price', models.DecimalField(decimal_places=2, max_digits=65, verbose_name='Discount price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product')),
                ('store_house', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='storehouse.storehouse')),
            ],
            options={
                'verbose_name': 'Product Specification Value',
                'verbose_name_plural': 'Product Specification Values',
